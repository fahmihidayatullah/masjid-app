  ...
  setYoutubeUrl
    ...
    return (
            <div className="setting-container">
                ...
                <div className="button-group" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, marginTop: 32 }}>
                    <div style={{ display: 'flex', gap: 12 }}>
                        <button className="setting-button" style={{ minWidth: 140, height: 48, fontSize: '1.1rem' }} onClick={() => setCurrentPage && setCurrentPage('deteksi')}>
                            Counting
                        </button>
                        <button className="setting-button" style={{ minWidth: 140, height: 48, fontSize: '1.1rem' }} onClick={() => setCurrentPage && setCurrentPage('cctv')}>
                            CCTV
                        </button>
                    </div>
                    <div style={{ display: 'flex', gap: 12 }}>
                        <button onClick={handleSave} className="setting-button" style={{ minWidth: 140, height: 48, fontSize: '1.1rem' }}>
                            Save
                        </button>
                        <button onClick={handleBackToWelcome} className="back-button" style={{ minWidth: 140, height: 48, fontSize: '1.1rem' }}>
                            Back
                        </button>
                    </div>
                </div>
